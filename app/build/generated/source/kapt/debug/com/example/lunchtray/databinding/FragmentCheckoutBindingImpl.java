...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String stringValueOfViewModelEntreePrice = null;
        java.lang.String stringValueOfViewModelSidePrice = null;
        java.lang.String viewModelTaxGetValue = null;
        java.lang.String stringValueOfViewModelAccompanimentPrice = null;
        ...
        double viewModelAccompanimentPrice = 0.0;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x181L) != 0) {
                    ...
                    if (viewModelAccompanimentGetValue != null) {
                        ...
                        // read viewModel.accompaniment.getValue().price
                        viewModelAccompanimentPrice = viewModelAccompanimentGetValue.getPrice();
                    }


                    // read String.valueOf(viewModel.accompaniment.getValue().price)
                    stringValueOfViewModelAccompanimentPrice = java.lang.String.valueOf(viewModelAccompanimentPrice);
            }
            ...
            if ((dirtyFlags & 0x184L) != 0) {
                    ...
                    // read String.valueOf(viewModel.entree.getValue().price)
                    stringValueOfViewModelEntreePrice = java.lang.String.valueOf(viewModelEntreePrice);
            }
            ...
            if ((dirtyFlags & 0x190L) != 0) {
                    ...
                    // read String.valueOf(viewModel.side.getValue().price)
                    stringValueOfViewModelSidePrice = java.lang.String.valueOf(viewModelSidePrice);
            }
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.accompanimentPrice, stringValueOfViewModelAccompanimentPrice);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreePrice, stringValueOfViewModelEntreePrice);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreeSelection, viewModelEntreeName);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.sidePrice, stringValueOfViewModelSidePrice);
